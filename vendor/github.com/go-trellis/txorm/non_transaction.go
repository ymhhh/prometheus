...
func (p *TXorm) NonTX(fn interface{}, repos ...interface{}) errors.ErrorCode {
	return p.NonTXWithName(fn, DefaultDatabase, repos...)
}

// NonTXWithName do non transaction function with name of database
func (p *TXorm) NonTXWithName(fn interface{}, name string, repos ...interface{}) errors.ErrorCode {
...
func (p *TXorm) beginNonTransaction(name string) errors.ErrorCode {
	if p.isTransaction {
...
func (p *TXorm) commitNonTransaction(txFunc interface{}, name string, repos ...interface{}) errors.ErrorCode {
	if p.isTransaction {
