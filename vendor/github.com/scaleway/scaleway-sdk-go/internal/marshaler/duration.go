...
// Duration implements a JSON Marshaler to encode a time.Duration in microSeconds.
type Duration int64

const microSec = Duration(time.Microsecond)
...
// MarshalJSON encodes the Duration in microSeconds.
func (d Duration) MarshalJSON() ([]byte, error) {
	return json.Marshal(int64(d / microSec))
}

// UnmarshalJSON decodes microSeconds to Duration.
